...
- `docs/DEMO_QA_CHECKLIST.md` updated to reflect this caveat
...
- Added pointers to `docs/EXAMINER_QA_30.md` and `docs/ARCHITECTURE.md`
...
- Use `docs/EXAMINER_QA_30.md` as your main speaking prep
- Use `docs/ARCHITECTURE.md` for technical follow-up, but rely on the updated wording
- Use `docs/FORCED_ARCHITECTURE_50Q.md` only as deep backup / improvement discussion
