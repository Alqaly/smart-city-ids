...
**Done!** Your Smart City IDS is running. 🚀
...
```bash
# Port-forward a service (terminal 1)
...
```bash
# Simulate 15 concurrent attackers for 30 seconds
...
```bash
# Extract sensitive healthcare data
...
```bash
# (Simulated - actual exploit would be kernel-level)
...
### Mock Mode (for development without attacks)
