...
- Current project reality: scenario explicitly models unauthorized Modbus write impacting AQI registers (`services/ids-api/static/index.html`, `docs/reference/PROJECT_METRICS.md`).
...
- Protocol and register map context:
  - `docs/reference/PROJECT_METRICS.md`
